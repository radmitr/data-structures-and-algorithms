package algorithms.basis.recursion;
 ...
 * ------------------------------------------------------------------------------------------------
 */
public class GettingSimpleList {

    public static void main(String[] args) {
        List<Object> listOfLists =
                List.of(1, List.of(2, 3), List.of(4, 5, List.of(6, 7)), List.of(8, List.of(9)), 10);
        System.out.println(listOfLists);
        System.out.println(getFlatList(listOfLists));
    }

    public static List<Integer> getFlatList(List<?> list) {
        List<Integer> resultList = new ArrayList<>();
        getFlatList(list, resultList);
        return resultList;
    }

    private static void getFlatList(List<?> list, List<Integer> resultList) {
        for (Object element : list) {
            if (element instanceof Integer) {
                resultList.add((Integer) element);
            } else if (element instanceof List<?>) {
                getFlatList((List<?>)element, resultList);
            } else {
