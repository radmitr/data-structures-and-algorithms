package data_structures.graphs.simple.bfs;

import data_structures.graphs.simple.dfs.GraphAdjacencyMatrixDFS;
 ...
 * поочередный обход ближайших вершин к стартовой. В отличии от поиска в глубину, сначала
 ...
 *
 * В отличии от поиска в глубину, поиск в ширину реализуется обычным циклическим алгоритмом
 ...
 * все вершины на цвет. Если все вершины поменяли цвет, то граф связный, если остались «белого
 * цвета» то граф не связный.
 * ------------------------------------------------------------------------------------------------
...
public class GraphAdjacencyMatrixBFS {
    ...
    public static void main(String[] args) throws IllegalAccessException {
        GraphAdjacencyMatrixBFS graph = new GraphAdjacencyMatrixBFS();
