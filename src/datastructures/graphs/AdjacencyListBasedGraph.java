 ...
 *
 * Представление графа в виде списка смежности подразумевает хранение списка вершин, в то же время
 ...
 * ребер гораздо меньше квадрата количества вершин). Представление в виде матрицы смежности
