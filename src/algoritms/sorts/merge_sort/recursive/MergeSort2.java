...
public class MergeSort2 {
	...
	public static <T> void sort(T[] array, Comparator<T> comp) {
		...
		sort(array, support, comp, startIndex, endIndex);
	}

	public static <T> void sort(T[] array, T[] support, Comparator<T> comp, int startIndex, int endIndex) {
		if (startIndex >= endIndex) {
			return;
		}
		int middle = startIndex + (endIndex - startIndex) / 2;
		sort(array, support, comp, startIndex, middle);
		sort(array, support, comp, middle + 1, endIndex);
