 ...
 */
/*
    1. Память под пару ключ-значение выделяется по мере необходимости.
    2. Применяется ленивое удаление пар.
*/
public class DoubleHashingHashTable2 {
    ...
    public DoubleHashingHashTable2() {
    ...
    public void put(String key, Object value) {
        ...
        while (true) {
            ...
            if (pairTable[addIndex] == null) {
                pairTable[addIndex] = new Pair(key, value);
                pairTable[addIndex].isPresent = true;
                size++;
//                System.out.println(key + ":" + value + ", (index=" + addIndex + ")"); // трассировка
                break;
            } else if (!pairTable[addIndex].isPresent) {
...
//                System.out.println(key + ":" + value + ", (index=" + addIndex + ")"); // трассировка
    ...
    public Object get(String key) {
        ...
        while (true) {
            ...
            if (pairTable[getIndex] == null || !pairTable[getIndex].isPresent) {
                return null;
            } else {
    ...
    public boolean remove(String key) {
        ...
        while (true) {
            ...
            if (pairTable[removeIndex] == null || !pairTable[removeIndex].isPresent) {
                return false;
            } else {
...
//                        System.out.println("nextRemoveIndex=" + nextRemoveIndex); // трассировка
                        if (pairTable[nextRemoveIndex] == null || !pairTable[nextRemoveIndex].isPresent) {
    ...
    public static void main(String[] args) {
        DoubleHashingHashTable2 hashTable = new DoubleHashingHashTable2();
